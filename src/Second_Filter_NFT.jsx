...
function Second_Filter_NFT(){
    ...
    return(
        <>
            <h1 className='mt-5 text-white text-center mobile-heading main-heading'>Select Your Favorite Armor</h1>
            ...
            {/* Main Section */}
                    <div  className='container filter-gallery'>
...
export default Second_Filter_NFT;