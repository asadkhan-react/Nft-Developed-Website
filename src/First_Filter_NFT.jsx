...
function First_Filter_NFT(){
    ...
    return(
        <>
            <h1 className='mt-5 text-white text-center mobile-heading main-heading'>Select Your Favorite Weapon</h1>
...
export default First_Filter_NFT;